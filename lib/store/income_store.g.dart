...
mixin _$IncomeStore on _IncomeStore, Store {
  late final _$incomesAtom = Atom(
    name: '_IncomeStore.incomes',
    context: context,
  );

  @override
  ObservableList<Transaction> get incomes {
    _$incomesAtom.reportRead();
    return super.incomes;
  }

  @override
  set incomes(ObservableList<Transaction> value) {
    _$incomesAtom.reportWrite(value, super.incomes, () {
      super.incomes = value;
    });
  }

  late final _$_IncomeStoreActionController = ActionController(
    name: '_IncomeStore',
    context: context,
  );
  ...
  void setIncomes(List<Transaction> initialIncomes) {
    final _$actionInfo = _$_IncomeStoreActionController.startAction(
      name: '_IncomeStore.setIncomes',
    );
    try {
      return super.setIncomes(initialIncomes);
    } finally {
